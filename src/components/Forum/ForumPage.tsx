...
export function ForumPage() {
  ...
  const fetchForums = async () => {
    try {
      const res = await apiService.getForums(user?.team_id); // still supports team filter
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Discuss with your peers</p>
      </div>
        ...
        <div className="lg:col-span-3">
          {selectedForum ? (
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex justify-end mt-2">
                      <button
                        ...
                        className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center space-x-2 transition-colors"
                      >
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center">
              ...
              <p className="text-gray-600">Choose a forum from the sidebar to start discussing.</p>
            </div>
          )}
        </div>
      </div>
